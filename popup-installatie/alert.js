...
div.setAttribute("style", "opacity:0.6;border-radius:15px;background-color:#4267b2;padding:15px;position: fixed;top: 50px;right: 0px;z-index:9999;");

var h3 = document.createElement("h3");
h3.setAttribute("style", "color:white;font-size:17px;text-align:center;");
